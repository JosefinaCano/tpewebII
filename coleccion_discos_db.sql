...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2026 at 01:35 PM
...
--
-- Indexes for table `coleccion_usuario`
--
...
--
-- AUTO_INCREMENT for table `coleccion_usuario`
--
ALTER TABLE `coleccion_usuario`
...
--
ALTER TABLE `discos`
  ADD CONSTRAINT `discos_ibfk_1` FOREIGN KEY (`id_artista`) REFERENCES `artistas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `discos_ibfk_2` FOREIGN KEY (`id_genero`) REFERENCES `generos` (`id`);
COMMIT;
